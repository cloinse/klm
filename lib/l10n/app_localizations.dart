...
class AppLocalizations {
  ...
  static const _values = <String, Map<String, String>>{
    'en': {
      ...
      'confirmBatchRepairTitle': 'Confirm batch repair',
      'batchRepairSummary':
          '{matched} matched, {unmatched} unmatched, {ambiguous} ambiguous.',
      'matchedRepairs': 'Ready to repair',
      'unmatchedLibraries': 'No matching folder',
      'ambiguousLibraries': 'Ambiguous matches',
      ...
      'classicOrderNeedsRepair': 'The classic order needs repair',
      'recordsRemovedOrderWarning':
          'The selected records were removed, but the classic order could not be updated. {reason}',
    ...
    'es': {
      ...
      'repairSelected': 'Reparar seleccionadas ({count})',
      'confirmBatchRepairTitle': 'Confirmar reparación por lotes',
      'batchRepairSummary':
          '{matched} coincidentes, {unmatched} sin coincidencia, {ambiguous} ambiguas.',
      'matchedRepairs': 'Listas para reparar',
      'unmatchedLibraries': 'Sin carpeta coincidente',
      'ambiguousLibraries': 'Coincidencias ambiguas',
      ...
      'classicOrderNeedsRepair': 'El orden clásico necesita reparación',
      'recordsRemovedOrderWarning':
          'Los registros seleccionados fueron eliminados, pero no se pudo actualizar el orden clásico. {reason}',
      'closeKontaktBeforeOrderSave':
    ...
    'pt': {
      ...
      'repairSelected': 'Reparar selecionadas ({count})',
      'confirmBatchRepairTitle': 'Confirmar reparo em lote',
      'batchRepairSummary':
          '{matched} correspondentes, {unmatched} sem correspondência, {ambiguous} ambíguas.',
      'matchedRepairs': 'Prontas para reparar',
      'unmatchedLibraries': 'Sem pasta correspondente',
      'ambiguousLibraries': 'Correspondências ambíguas',
      ...
      'classicOrderNeedsRepair': 'A ordem clássica precisa de reparo',
      'recordsRemovedOrderWarning':
          'Os registros selecionados foram removidos, mas não foi possível atualizar a ordem clássica. {reason}',
      'closeKontaktBeforeOrderSave':
    ...
    'zh': {
      ...
      'repairSelected': '修复所选项（{count}）',
      'confirmBatchRepairTitle': '确认批量修复',
      'batchRepairSummary':
          '已匹配 {matched} 项，未匹配 {unmatched} 项，存在歧义 {ambiguous} 项。',
      'matchedRepairs': '可修复',
      'unmatchedLibraries': '没有匹配的文件夹',
      'ambiguousLibraries': '匹配存在歧义',
      ...
      'classicOrderNeedsRepair': '经典排序需要修复',
      'recordsRemovedOrderWarning': '所选记录已删除，但无法更新经典排序。{reason}',
